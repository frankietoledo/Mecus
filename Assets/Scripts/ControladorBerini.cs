...
public class ControladorBerini : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzadoBerini", 1 );
        repintar();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 4)
        {
            ...
            PlayerPrefs.SetInt( "maximoNivelAlcanzadoBerini", maximoNivelAlcanzado );
        }
    }
