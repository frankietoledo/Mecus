...
public class ControladorSocEspañola : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzadoSocEsp", 1 );
        repintar();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 4)
        {
            ...
            PlayerPrefs.SetInt( "maximoNivelAlcanzadoSocEsp", maximoNivelAlcanzado );
        }
    }
