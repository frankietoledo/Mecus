...
public class ControladorHotelRoma : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzadoHotelRoma", 1 );
        repintar();
    }
    ...
    private void iniciarNivel20( )
    {
        ...
        juego20.GetComponentInChildren<BarajadorDePuertas>().iniciarNivel();
    }
    private void iniciarNivel3( )
    {
        juego3.SetActive( true );
        juego3.GetComponentInChildren<BarajadorDePuertas>().iniciarNivel();
    }
    private void iniciarNivel2( )
    {
        juego2.SetActive( true );
        juego2.GetComponentInChildren<BarajadorDePuertas>().iniciarNivel();
    }
    private void iniciarNivel1( )
    {
        juego1.SetActive( true );
        juego1.GetComponentInChildren<BarajadorDePuertas>().iniciarNivel();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 4)
        {
            ...
            PlayerPrefs.SetInt( "maximoNivelAlcanzadoHotelRoma", maximoNivelAlcanzado );
        }
    }
