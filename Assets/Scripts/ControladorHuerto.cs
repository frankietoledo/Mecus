...
public class ControladorHuerto : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzadoHuerto", 1 );
        repintar();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 3)
        {
            actualizarItems( 1, 2 );
            maximoNivelAlcanzado += 1;
            PlayerPrefs.SetInt( "maximoNivelAlcanzadoHuerto", maximoNivelAlcanzado );
        }
    }
