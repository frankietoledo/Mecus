...
public class ControladorPuenteFierro : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzado", 1 );
        repintar();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 4)
        {
            ...
            PlayerPrefs.SetInt( "maximoNivelAlcanzado", maximoNivelAlcanzado );
        }
    }
