...
public class ControladorMunicipalidad : MonoBehaviour
{
    ...
    private void Start( )
    {
        ...
        maximoNivelAlcanzado = PlayerPrefs.GetInt( "maximoNivelAlcanzadoMunicipalidad", 1 );
        repintar();
    }
    ...
    public void mostrarPantallaDeVictoria( )
    {
        ...
        if (maximoNivelAlcanzado < nivelActual && nivelActual <= 4)
        {
            ...
            PlayerPrefs.SetInt( "maximoNivelAlcanzadoMunicipalidad", maximoNivelAlcanzado );
        }
    }
